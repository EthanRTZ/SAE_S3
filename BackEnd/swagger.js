...
const options = {
  definition: {
    ...
    tags: [
      ...
      { name: 'Equipements', description: 'Gestion des équipements' },
      { name: 'Billets', description: 'Gestion des billets et réservations' },
      { name: 'Zones', description: 'Gestion des zones de la carte' },
      { name: 'Types de Service', description: 'Gestion des types de service' },
      { name: 'Avis', description: 'Gestion des avis prestataires' },
